...
$opt_responder["M15"][2] = "Ettercap";
$opt_responder["M15"][3] = "/modules/ettercap/includes/module_action.php?service=ettercap&action=start&page=status";

$opt_responder["M16"][0] = 0;
$opt_responder["M16"][1] = 0;
$opt_responder["M16"][2] = "Kismet";
$opt_responder["M16"][3] = "/modules/kismet/includes/module_action.php?service=kismet&action=start&page=status";

$opt_responder["M17"][0] = 0;
$opt_responder["M17"][1] = 0;
$opt_responder["M17"][2] = "mdk3";
$opt_responder["M17"][3] = "/modules/mdk3/includes/module_action.php?service=mdk3&action=start&page=status";

$opt_responder["M18"][0] = 0;
$opt_responder["M18"][1] = 0;
$opt_responder["M18"][2] = "Meterpreter";
$opt_responder["M18"][3] = "/modules/meterpreter/includes/module_action.php?service=meterpreter&action=start&page=status";

$opt_responder["M19"][0] = 0;
$opt_responder["M19"][1] = 0;
$opt_responder["M19"][2] = "MITMf";
$opt_responder["M19"][3] = "/modules/mitmf/includes/module_action.php?service=mitmf&action=start&page=status";

$opt_responder["M20"][0] = 0;
$opt_responder["M20"][1] = 0;
$opt_responder["M20"][2] = "Nessus";
$opt_responder["M20"][3] = "/modules/nessus/includes/module_action.php?service=nessus&action=start&page=status";

$opt_responder["M21"][0] = 0;
$opt_responder["M21"][1] = 0;
$opt_responder["M21"][2] = "ngrep";
$opt_responder["M21"][3] = "/modules/ngrep/includes/module_action.php?service=ngrep&action=start&page=status";

$opt_responder["M22"][0] = 0;
$opt_responder["M22"][1] = 0;
$opt_responder["M22"][2] = "Phishing";
$opt_responder["M22"][3] = "/modules/phishing/includes/module_action.php?service=phishing&action=start&page=status";

$opt_responder["M23"][0] = 0;
$opt_responder["M23"][1] = 0;
$opt_responder["M23"][2] = "Recon";
$opt_responder["M23"][3] = "/modules/recon/includes/module_action.php?service=recon&action=start&page=status";

$opt_responder["M24"][0] = 0;
$opt_responder["M24"][1] = 0;
$opt_responder["M24"][2] = "Responder";
$opt_responder["M24"][3] = "/modules/responder/includes/module_action.php?service=responder&action=start&page=status";

$opt_responder["M25"][0] = 0;
$opt_responder["M25"][1] = 0;
$opt_responder["M25"][2] = "RPiTwit";
$opt_responder["M25"][3] = "/modules/rpitwit/includes/module_action.php?service=rpitwit&action=start&page=status";

$opt_responder["M26"][0] = 0;
$opt_responder["M26"][1] = 0;
$opt_responder["M26"][2] = "Squid3";
$opt_responder["M26"][3] = "/modules/squid3/includes/module_action.php?service=squid3&action=start&page=status";

$opt_responder["M27"][0] = 0;
$opt_responder["M27"][1] = 0;
$opt_responder["M27"][2] = "SSLstrip";
$opt_responder["M27"][3] = "/modules/sslstrip/includes/module_action.php?service=sslstrip&action=start&page=status";

$opt_responder["M28"][0] = 0;
$opt_responder["M28"][1] = 0;
$opt_responder["M28"][2] = "SSLstrip2";
$opt_responder["M28"][3] = "/modules/sslstrip2/includes/module_action.php?service=sslstrip2&action=start&page=status";

$opt_responder["M29"][0] = 0;
$opt_responder["M29"][1] = 0;
$opt_responder["M29"][2] = "Tcpdump";
$opt_responder["M29"][3] = "/modules/tcpdump/includes/module_action.php?service=tcpdump&action=start&page=status";

$opt_responder["M30"][0] = 0;
$opt_responder["M30"][1] = 0;
$opt_responder["M30"][2] = "Tor";
$opt_responder["M30"][3] = "/modules/tor/includes/module_action.php?service=tor&action=start&page=status";

$opt_responder["M31"][0] = 0;
$opt_responder["M31"][1] = 0;
$opt_responder["M31"][2] = "URLSnarf";
$opt_responder["M31"][3] = "/modules/urlsnarf/includes/module_action.php?service=urlsnarf&action=start&page=status";

$opt_responder["M32"][0] = 0;
$opt_responder["M32"][1] = 0;
$opt_responder["M32"][2] = "WhatsApp";
$opt_responder["M32"][3] = "/modules/whatsapp/includes/module_action.php?service=whatsapp&action=start&page=status";
